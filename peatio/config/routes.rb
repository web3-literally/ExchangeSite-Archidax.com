...
Peatio::Application.routes.draw do
  ...
  get '/exchage-platform', to: 'static_pages#exchage_platform'
  get '/terms', to: 'static_pages#terms_of_use'
  get '/privacy', to: 'static_pages#privacy_policy'
  get '/mining', to: 'static_pages#mining'
  get '/api', to: 'static_pages#api'
  get '/mobile_app', to: 'static_pages#mobile_app'
  ...
  scope module: :private do
    ...
    get '/dashboard', to: 'settings#dashboard'
    ...
    get '/history/rewards' => 'history#rewards', as: :reward_history
