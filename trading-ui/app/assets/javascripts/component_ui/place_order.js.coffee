@PlaceOrderUI = flight.component ->
  ...
  @after 'initialize', ->
    ...
    $('#order_bid_price').attr('readonly', 'true')
    $('#order_ask_price').attr('readonly', 'true')
    $('#order_bid_price').attr('placeholder', 'Market Price')
    $('#order_ask_price').attr('placeholder', 'Market Price')

    $('#active_limit').on 'click', =>
      $('#active_limit').addClass('active')
      $('#active_market').removeClass('active')
      $('#order_ask_price').attr('readonly', false)
      $('#order_ask_price').attr('placeholder', '')
      $('#order_ask_ord_type').val('limit')
      $('#order_bid_price').attr('readonly', false)
      $('#order_bid_price').attr('placeholder', '')
    ...
    $('#sell_form').on 'click', =>
      $('#buy_form').removeClass('active')
      $('#sell_form').addClass('active')
      $('#bid_entry').addClass('hidden-mobile')
      $('#ask_entry').removeClass('hidden-mobile')

    $('#buy_form').on 'click', =>
      $('#buy_form').addClass('active')
      $('#sell_form').removeClass('active')
      $('#bid_entry').removeClass('hidden-mobile')
      $('#ask_entry').addClass('hidden-mobile')
